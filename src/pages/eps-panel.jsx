          ...
          <div className="flex flex-wrap items-center">
            <div className="ml-auto mr-auto mt-10 w-full px-4 text-center lg:w-8/12">
              ...
              <Typography variant="lead" color="white" className=" opacity-80">
                EPS panel is safe because it does not contain harmful chemicals
                at all to human body, and it has excellent bending strength and
                compressive strength. So it has excellent durability.
              </Typography>
            </div>
          </div>
        </div>
